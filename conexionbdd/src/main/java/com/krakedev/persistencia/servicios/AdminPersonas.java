...
public class AdminPersonas {
	...
	public static void insertar(Persona persona) throws Exception{
		...
		try {
			...
			ps=con.prepareStatement("insert into datos (cedula,nombre,apellido,estado_civil_codigo,numero_hijos,estatura,cantidad_ahorrada,fecha_nacimiento,hora_nacimiento)"
					+ "			values(?,?,?,?,?,?,?,?,?)");
	...
	public static void actualizar(Persona persona) throws Exception{
		...
		try {
			...
			ps = con.prepareStatement(
					"update datos set nombre=?, apellido=?, estado_civil_codigo=?, numero_hijos=?, estatura=?, cantidad_ahorrada=?,fecha_nacimiento=?,hora_nacimiento=? where cedula=?");
	...
	public static ArrayList<Persona> buscarPorNombre(String nombreBusqueda) throws Exception{
		...
		try {
			con=ConexionBDD.conectar();
			ps=con.prepareStatement("select * from datos where nombre like ?");
